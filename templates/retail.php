            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <select class="form-select" id="productSelect">
                        ...
                        <option value="<?= $p['id'] ?>" data-name="<?= htmlspecialchars($p['name']) ?>" data-sku="<?= htmlspecialchars($p['sku']) ?>" data-price="<?= $p['selling_price'] ?>" data-stock="<?= $p['stock_quantity'] ?>">
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <select name="payment_method" class="form-select"><option value="cash">Cash</option><option value="card">Card</option><option value="upi">UPI</option></select>
                    </div>
                    <div class="mb-3">
                    ...
                    <button type="button" class="btn btn-outline-primary w-100" id="payFullBtn"><i class="bi bi-cash me-2"></i>Pay Full Amount</button>
                </div>
            </div>
